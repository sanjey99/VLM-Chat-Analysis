...
// Use Tauri's HTTP plugin when running inside the Tauri runtime (native fetch
// is blocked by WebKit for http:// origins). Fall back to native fetch in a
// plain browser dev session.
